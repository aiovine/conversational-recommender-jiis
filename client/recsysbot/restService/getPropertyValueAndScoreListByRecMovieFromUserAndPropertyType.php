...
function getPropertyValueAndScoreListByRecMovieFromUserAndPropertyType($chatId, $propertyType){
   ...
   $stringGetRequest = '/'.getServiceName().'/restService/recMovieTopropertyValueAndScoreList/getPropertyValueAndScoreListByRecMovieFromUserAndPropertyType?userID='.$userID.'&propertyType='.urlencode($propertyType);
