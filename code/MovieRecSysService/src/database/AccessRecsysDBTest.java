...
public class AccessRecsysDBTest {
	...
	public static void testSelectMoviesAndPropertyByUser() throws Exception {
		//System.out.println("Original: " + db.selectMoviesAndPropertyByUser(0, "like"));
		System.out.println("New: " + db.selectMoviesAndPropertyByUser(0, "like", prop));
	}
	...
	public static void testSelectTestSetForUserFromMoviesForPageRank() throws Exception {
		Map<String, Set<String>> original = db.selectTestSetForUserFromMoviesForPageRank(0);
		Map<String, Set<String>> mod = db.selectTestSetForUserFromMoviesForPageRank(0);
		System.out.println("Original: " + original.get("0").size());
		System.out.println("New: " + mod.get("0").size());
		mod.get("0").removeAll(original.get("0"));
