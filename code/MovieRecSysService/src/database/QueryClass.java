...
public class QueryClass {
	...
	public static String SQLinsertRecMovieRated (int user_id, String movieURI, int number_recommendation_list, int rating,int position,int pagerank_cicle, String refine,String refocus, String botName,String message_id, int bot_timestamp, String recommendatinsList,String ratingsList){
	...
	public static String SQLinsertRecMovieToRating (int user_id, String movieURI, int number_recommendation_list, int position,int pagerank_cicle, String botName, String message_id, int bot_timestamp, int response_time, String recommendationListString){
		//`user_id`, `movieURI`, `rating`, `position`, `pagerank_cicle`, `refineRefocus`, `botName`, `message_id`, `bot_timestamp`, `recommendatinsList`, `ratingsList`, `number_recommendation_list`
	...
	public static String SQLinsertChatMessage(int user_id, String message_id, String context, String replyText, String replyFuctionCall, int pagerank_cicle, int number_recommendation_list, String botName, int bot_timestamp, int response_time, String responseType, int number_rated_movies, int number_rated_properties){
	...
	public static String SQLgetNumberRatedPropertiesWithoutDuplicates(int user_id) {
	...
	public static String SQLdeletePropertyRatedByUser(int user_id, String uri) {
		String SQL = 	"DELETE FROM `" + DBConstants.dbName + "`.`ratings_properties`"
				+ " WHERE `user_id` = " + user_id
	...
	public static String SQLdeleteMovieRatedByUser(int user_id, String uri) {
		String SQL = 	"DELETE FROM `" + DBConstants.dbName + "`.`ratings_movies`"
						+ " WHERE `user_id` = " + user_id
						+ " AND `movie_uri` = '" + uri + "';";
		return SQL;
	...
	public static String SQLselectNumberOfRatedMoviesAndSkippedByUser(int user_id) {
	...
	public static String SQLselectNumberOfRatedMoviesSkippedByUser(int user_id) {
	...
	public static String SQLselectMovie(String uri) {   //TODO
		return "SELECT uri FROM entities WHERE uri = ?";
	}
...
//						" AND " + propertyTable + "." + columnPropertyURI + " = \"" + propertyURI + "\";";
	...
	public static String SQLselectAcceptRecMovieToControlling(int user_id){
	...
	public static String SQLselectAcceptRecMovieToSkipping(int user_id){
		String SQL = 	"SELECT movie_uri FROM ratings_movies "
						+ "WHERE `user_id` = " + user_id + " AND rating = 2";
	 ...
	 */
	public static String SQLselectMovieToRatingByPop(int user_id){
		String SQL = 	"SELECT uri, COUNT(rating) AS nOfRatings "
					+ 	"FROM ml_ratings_mapped "
					+ 	"WHERE uri NOT IN ( "
					+ 	"	SELECT movie_uri "
					+ 	"	FROM ratings_movies AS r "
					+ 	"	WHERE r.user_id = " + user_id +	") "
					+ 	"GROUP BY uri "
					+ 	"ORDER BY nOfRatings DESC LIMIT 1;";
		return SQL;
	}
	
	public static String SQLselectMovieToRatingByRandom(int user_id){
	...
	public static String selectRatedMovieByUser(int user_id){
		String SQL =	"SELECT movie_uri as uri "
					+ 	"FROM ratings_movies as r "
					+ 	"WHERE r.user_id = " + user_id + ";";
		return SQL;
	}
	
	public static String SQLselectMoviesGroupByRatings(int user_id){
		String SQL = 	"SELECT uri, rating, COUNT(rating) AS nOfRatings "
					+ 	"FROM ml_ratings_mapped "
					+ 	"WHERE uri NOT IN ( "
					+ 	"	SELECT movie_uri "
					+ 	"	FROM ratings_movies AS r "
	...
	public static String SQLselectRatingsForUserFromRatingsProperties(int user_id) {
		String SQL =    "SELECT property_uri, property_type_uri, rating FROM ratings_properties" +
	                    " WHERE `user_id` = " + user_id + " "
	                    + "AND `last_change` = 'user'";
		return SQL;
	...
	public static String SQLselectRatingsForUserFromRatingsMovies(int user_id) {
		String SQL =    "SELECT movie_uri, rating FROM " + DBConstants.dbName + ".ratings_movies" + 
	                    " WHERE `user_id` = " + user_id + " "
	                    + "AND `last_change` = 'user'";
		return SQL;
...
//	}
	...
	public static String SQLselectTestSetForUserFromMovies(int user_id) { //TODO
...
//}
	...
	public static String getAddDialogStateQuery(int userID, String state) {
		return "INSERT INTO dialog_states (`user_id`, `state`)" +
		 " VALUES (?, ?)" +
		 " ON DUPLICATE KEY UPDATE `state` = VALUES(state);";
	}
	
	public static String getReadDialogStateQuery(int userID) {
	...
	public static String getInsertMessageInLogQuery() {
		return "INSERT INTO messages_log (message_id, user_id, message, timestamp_start, timestamp_end, intent, contexts, recognized, events, pagerank_cicle, number_recommendation_list, interaction_type) "
				+ "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
	}
	...
	/**
	 * Select di tutte le triple USER-URI-RATING dal dataset di MovieLen
	 * per le quali la label del film ha un URI corrispondente nella tabella entities
	 * insieme a tutte le triple USER-URI-RATINGdell'utente convertendo la scala di rating 
	 * e utilizzando un identificativo fittizio per l'utente
	 * 
	 ...
	 * @return			Query
	 */
	public static String getAllRatingsForLibRec(int userId, String dummyId) {
		return    "SELECT userId, uri, rating "
				+ "FROM ml_ratings_mapped "
				+ "UNION "
				+ "SELECT \""+ dummyId +"\" AS userId, movie_uri AS uri, IF(rating > 0 , 5.0, 1.0) as rating "
				+ "FROM ratings_movies "
				+ "WHERE user_id = " + userId + " AND rating != 2";
	}
