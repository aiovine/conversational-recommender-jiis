...
public class DatasetPopulationManager {
	...
	public void processMessage(DialogState state, JsonObject response, int userID, String messageID, String message, String intent, String contexts, boolean saveOnDatabase) {
	 ...
	 */
	public void checkTaskStartingConditions(DialogState state, JsonObject response, int userID, String message, String intent, String contexts) {
	 ...
	 */
	public void checkTaskStartingConditionsFromEvent(DialogState state, JsonObject response, int userID, String message, String intent, String contexts) {
