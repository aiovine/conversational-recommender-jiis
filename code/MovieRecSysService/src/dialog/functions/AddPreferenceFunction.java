...
public class AddPreferenceFunction {
	 ...
	 */
	public AddPreferenceResponse addPreferences(String message, int userID, String[] stopWords, String currentRecommendedEntity, ItemSuggestion currentEntityToRate) {
	...
	private void addRecommendedEntityPreference(Alias recEntityAlias, int userID, int sentiment, EntityService es, AddPreferenceResponse response, boolean setCritiquing) {
		int rating = getRatingFromSentiment(sentiment);
		//We add the preference to the recommended item
	...
	private void addSuggestedItemPreference(Preference preference, Alias suggEntityAlias, int userID, int sentiment, EntityService es, PropertyService ps, AddPreferenceResponse response) {
		int rating = getRatingFromSentiment(sentiment);
		//We add the preference to the suggested item
		LOGGER.log(Level.INFO, "Rating is " + rating);
	 ...
	 */
	public AddSinglePreferenceResponse addSinglePreference(String uri, String name, int rating, int userID) {
