...
public class DeletePreferenceFunction {
	...
	public DeletePreferenceResponse deletePreferencesInMessage(String message, int userID) {
	...
	public void deleteSinglePreference(int userID, String uri, String name) {
