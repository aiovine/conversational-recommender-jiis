...
public class DisambiguationFunction {
	 ...
	 * @return
	 */
	public DisambiguationResponse doPreferenceDisambiguation(String message, int userID, Preference preference) {
	 ...
	 */
	private DisambiguationResponse doPropertyTypeDisambiguation(PendingEvaluation evaluation, String message, int userID) {
	 ...
	 * @return a DisambiguationResponse object containing the outcome of the disambiguation
	 */
	private DisambiguationResponse doNameDisambiguation(PendingEvaluation evaluation, String message, int userID) {
