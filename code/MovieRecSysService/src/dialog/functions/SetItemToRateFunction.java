...
public class SetItemToRateFunction {
	 ...
	 */
	public void setItemToRate(int userID, DialogState state, boolean advance) throws NoItemsToSuggestException {
	...
	private void getItemToRate(int userID, DialogState state, boolean advance) throws NoItemsToSuggestException {
		...
		if (ratedSuggestedItemsCount < Configuration.getDefaultConfiguration().getNumSuggestedItems()) {
			...
			if (newSuggestion != null) {
				state.setSuggestion(newSuggestion, advance);
			} else {
