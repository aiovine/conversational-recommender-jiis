...
public interface DialogPromptHandler {
	 ...
	 */
	public boolean check(int userID, QueryResult result, DialogState state, String messageID, HandlerResponse actionResponse);
	 ...
	 */
	public ApiAiResponse handle(int userID, QueryResult result, DialogState state, String messageID, HandlerResponse actionResponse);
}
