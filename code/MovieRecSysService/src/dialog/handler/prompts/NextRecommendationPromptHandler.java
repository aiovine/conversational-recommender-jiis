...
public class NextRecommendationPromptHandler implements DialogPromptHandler {
	...
	@Override
	public ApiAiResponse handle(int userID, QueryResult result, DialogState state, String messageID,
			HandlerResponse actionResponse) {
	...
	public ApiAiResponse getNextRecommendedEntity(int userID, List<String> recommended, DialogState state) {
...
//		response.setData(dataObj);
	...
	private ApiAiResponse getRecommendationReminder(DialogState state, int userID) {
