...
public class EntityRecommendation {
	...
	public void setPage(int page) {
		...
		if (page <= 5) {
			...
			if (state.getTop5Entities() != null) {
				...
				entityService.insertEntityToRate(Integer.parseInt(userID), entityService.getEntityURI(state.getEntityToRecommend()), page - 1);
			}
		}	
	}
	...
	public void putRecEntityRating(String rating) throws Exception {
		...
		service.addRecommendedEntityPreference(id, entityObjectUri, Integer.parseInt(rating), "user");
