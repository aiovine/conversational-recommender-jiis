...
public class LogService {
	...
	public void insertMessageInLog() {
		new AdaptiveSelectionController().insertMessageIntoLog(messageID, Integer.parseInt(userID), message, timestampStart, timestampEnd, intent, contexts, recognized, events, pagerankCycle, numberRecommendationList, interactionType);
	}
