...
public class PropertyService {
	 ...
	 */
	public boolean deleteAllRatedProperties(int userID) {
		AdaptiveSelectionController asController = new AdaptiveSelectionController();
	...
	public String getPropertyFromMovie(String movie_uri, int userID){
		return new AdaptiveSelectionController().getPropertyFromMovie(movie_uri, userID);
	}
	
	public String getPropertyFromMovies(String movie_uri, int userID){
