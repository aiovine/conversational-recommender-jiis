...
public class AuxServices {
	...
	public String getRecommendationAuxRequest(
		...
		DialogState state = dialogStateService.getDialogState(Integer.parseInt(truncatedID));
		EntityRecommendation entityRecommendation = new EntityRecommendation(truncatedID, timestamp, botName, state);
