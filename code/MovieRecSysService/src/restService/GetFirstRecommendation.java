...
public class GetFirstRecommendation {
	...
	public String getFirstRecommendationPost(String input) {
		...
		int userID = parameters.get("userID").getAsInt();
	...
	private Reply getRecommendations(int userID, String messageID, List<PropertyFilter> propertyFilters) {
		ApiAiResponse responseObject;
		List<String> recommendations = new Recommendation().getRecommendationList(String.valueOf(userID), propertyFilters, true);
