...
public class GetPropertyValueFromPropertyTypeAndEntity {
						   							...
						   							@QueryParam("propertyType") String propertyType) throws Exception 
	{
		...
		if (propertyType.equals("entity") &&  (!lastChange.equals("pagerank")|| !lastChange.equals("refine"))) {	
			asController.createGraphAndRunPageRank(user_id, null);
			propertyMap = asController.getPropertyValueAndScoreListByRecEntityFromUserAndPropertyType(user_id, propertyType);
		...
		System.out.print("/getPropertyValueFromPropertyTypeAndEntity?userID=" + user_id + "&propertyType=" + propertyType +"/");
		if (json.equals("null")) {
