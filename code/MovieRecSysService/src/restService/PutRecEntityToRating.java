...
public class PutRecEntityToRating {
								   	 ...
								   	 ) throws Exception 
	{
		...
		System.out.println("/.putRecEntityToRating/userID: " + user_id + " entityURI:" + entityURI + " numberRecommendationList:" + numberRecommendationList + "/");
		...
		if(entityURI != null && !entityURI.isEmpty()){
			asController.insertRecEntityToRatingByUser(user_id, entityURI,number_recommendation_list, pos, pagerank_cicle, botName, "0", bot_timestamp);
		}
		else {
			System.err.println("/putRecEntityToRating/Error - insertRecEntityToRatingByUser userID: " + user_id + " entityURI:" + entityURI);
		}		
		numberRatedEntities = asController.getNumberRatedEntities(user_id);		
		Gson gson = new Gson();
		String json = gson.toJson(numberRatedEntities);
			
		System.out.print("/putRecEntityToRating/userID: " + user_id + " entityURI:" + entityURI + " numberRecommendationList:" + numberRecommendationList + "/");
