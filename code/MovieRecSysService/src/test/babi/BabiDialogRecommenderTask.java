...
public class BabiDialogRecommenderTask implements Runnable {
	...
	private ConcurrentLinkedQueue<Integer> userIDQueue;
	private int userID;
	...
	public BabiDialogRecommenderTask(ConcurrentLinkedQueue<BabiDialogRecommendation> recQueue, 
			ConcurrentLinkedQueue<Integer> userIDQueue,
	...
	private void getRecommendation(int userID, 
	...
	private List<TestAddedElement> addPreferenceWithForcedEntities(String preference, int userID, Entity[] entities) {
	...
	private List<TestAddedElement> addPreference(String preference, int userID) {
		List<TestAddedElement> result = new ArrayList<>();
		EntityService es = new EntityService();
		PropertyService ps = new PropertyService();
	...
	private List<String> createGraphAndRunPageRankTest(int user_id) throws Exception {
	...
	public static void main(String[] args) {
		...
		ConcurrentLinkedQueue<Integer> user = new ConcurrentLinkedQueue<>();
